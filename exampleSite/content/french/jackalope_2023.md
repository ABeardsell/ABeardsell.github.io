...
### Inscriptions (dès le 14 novembre)
 ...
 Inscrivez-vous en cliquant sur ce lien: https://forms.gle/fg2YNiwfvQ1wtmnX7


 **Frais**: 675$ (par équipe). **Un maximum de 60 équipes pourront s'inscrire** pour des raisons de logistique.

**Les frais d'inscriptions incluent**: le transport des bacs et équipements (canot et vélos), la location d'un canot, les cartes du parcours, repas d'après-course le samedi, et une superbe aventure! Pour faciliter la logistique de cet événement, les canots personnels ne sont pas alloués.
